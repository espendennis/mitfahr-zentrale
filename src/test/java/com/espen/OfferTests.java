...
public class OfferTests {
	...
	public void testSearch(){
		...
		assertEquals("Retrieved offer should match", offer5, offersService.findSeveral("Berlin", "München", date, 100).toArray()[0]);
		assertEquals("Only one offer should be found", 1, offersService.findSeveral("Berlin", "München", date, 100).size());
		assertEquals("Offers should match if sorting was successfull", offer5, offersService.findSeveral("Berlin", "München", date, 300).toArray()[1]);
	}
